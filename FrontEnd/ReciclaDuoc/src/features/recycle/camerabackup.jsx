...
export default function CameraCapture({
    uploadUrl,                      // ej: "https://api.tuapp.com/upload"
    fieldName = "photo",            // nombre del campo form-data
    extraData = {},                 // { userId: "123", tipo: "reciclaje" }
    initialFacingMode = "environment",
    imageQuality = 0.85,            // 0..1 (JPEG)
    maxWidth,                       // redimensiona manteniendo aspecto (opcional)
    maxHeight,                      // redimensiona manteniendo aspecto (opcional)
}) {
    ...
    useEffect(() => {
        // cada vez que vuelves a modo cámara (photoBlob === null), reatacha el stream
    ...
    */
    ...
    return (
        <div className="flex flex-col items-center gap-3 p-4 max-w-md mx-auto">
            <h1 className="text-xl font-semibold">Capturar y Enviar Foto</h1>
            ...
            {!photoBlob ? (
                ...
                <div className="flex gap-2 w-full">
                    ...
                    <button
                        ...
                        style={{ backgroundColor: darkTeal, color: "white" }}
                    >
            ...
            {/* <div className="w-full">
                <label className="text-sm text-gray-600 block mb-1">
                    ¿Problemas con la cámara? Sube una foto:
                </label>
                <input
                    type="file"
                    accept="image/*"
                    capture="environment"
                    onChange={(e) => onFilePicked(e.target.files && e.target.files[0] ? e.target.files[0] : null)}

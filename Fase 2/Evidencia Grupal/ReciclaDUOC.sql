...
DROP TABLE IF EXISTS reciclaje_producto;
...
CREATE TABLE reciclaje_producto (
    id_reciclaje INTEGER NOT NULL,
    id_producto INTEGER NOT NULL,
    cantidad INTEGER NOT NULL,
    PRIMARY KEY (id_reciclaje, id_producto),
...
-- Productos
INSERT INTO producto (id_material, nombre, descripcion, valor_punto) VALUES
(1, 'Botella PET', 'Botella de plástico reciclable', 10),
(2, 'Botella de Vidrio', 'Botella de vidrio transparente', 15);
...
-- Reciclaje_Producto
INSERT INTO reciclaje_producto (id_reciclaje, id_producto, cantidad) VALUES
(1, 1, 5),
(2, 2, 3);